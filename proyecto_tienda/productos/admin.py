...
class ProductoAdmin(admin.ModelAdmin):
    fields = ('titulo','descripcion','precio','imagen')#este atributo debe ser una tupla y se usa para seleccionar los campos que se quieren mostrar en el admin de django
